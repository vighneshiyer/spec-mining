...
% Split signals across modules
% For each module only consider module port signals and signals below 5 bits
% For leaf modules consider internal signals as well
% Mine on permutations of all signal crosses on all automata
% Parallelize across module boundaries
